...
body {
  ...
  background-size: cover;
    ...
    <div class="container mt-3">
        ...
        <div class="card mt-2">
            <div class="card-header text-bg-danger">Data Album</div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hapus_album.php?albumid=<?= $data['albumid'] ?>" class="btn btn-outline-danger">Hapus</a>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="update_album.php" method="post">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-ouline-secondary" data-bs-dismiss="modal">Close</button>
